...
function [img,hdr] = read_image(hdr,filetype,fileprefix,machine,img_idx,dim5_idx,dim6_idx,dim7_idx,old_RGB)
   ...
   case   2,
      hdr.dime.bitpix = 8;  precision = 'uint8'; precision2 = 'uint8';
   case   4,
      hdr.dime.bitpix = 16; precision = 'int16'; precision2 = 'int16';
   case   8,
      hdr.dime.bitpix = 32; precision = 'int32'; precision2 = 'int32';
   case  16,
      hdr.dime.bitpix = 32; precision = 'float32'; precision2 = 'single';
   case  32,
      hdr.dime.bitpix = 64; precision = 'float32'; precision2 = 'single';
   case  64,
      hdr.dime.bitpix = 64; precision = 'float64'; precision2 = 'double';
   case 128,
      hdr.dime.bitpix = 24; precision = 'uint8'; precision2 = 'uint8';
   case 256 
      hdr.dime.bitpix = 8;  precision = 'int8'; precision2 = 'int8';
   case 511 
      hdr.dime.bitpix = 96; precision = 'float32'; precision2 = 'single';
   case 512 
      hdr.dime.bitpix = 16; precision = 'uint16'; precision2 = 'uint16';
   case 768 
      hdr.dime.bitpix = 32; precision = 'uint32'; precision2 = 'uint32';
   case 1024
      hdr.dime.bitpix = 64; precision = 'int64'; precision2 = 'int64';
   case 1280
      hdr.dime.bitpix = 64; precision = 'uint64'; precision2 = 'uint64';
   case 1792,
      hdr.dime.bitpix = 128; precision = 'float64'; precision2 = 'double';
   otherwise
   ...
   if hdr.dime.datatype == 1 | isequal(hdr.dime.dim(5:8),ones(1,4)) | ...
	(isempty(img_idx) & isempty(dim5_idx) & isempty(dim6_idx) & isempty(dim7_idx))
	 ...
	 img_siz = img_siz * 3;
      ...
      % preallocate img
      img = zeros(img_siz, length(img_idx)*length(dim5_idx)*length(dim6_idx)*length(dim7_idx),precision2);
      currentIndex = 1;
   ...
   %
   if hdr.dime.datatype == 32 | hdr.dime.datatype == 1792
%       img = reshape(img, [2, length(img)/2 length(img_idx)]);
%       img = squeeze(complex(img(1,:,:),img(2,:,:))); 
